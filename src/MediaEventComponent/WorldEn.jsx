...
export default function WorldEn() {
  return (
    <div>
        <Header/>
        ...
        <section className='container-fluid animate__animated animate__slideInUp' id='abouts'>
           ...
           <h5 className='pt-5'>HOME / World Event</h5>
           <h4>World Events Events</h4>
           </div>
                    ...
                    <div className="col-lg-8">
                        <div>
                          ...
                          <div className='even p-2'>
                            <h2>Monsoon Magic with Ashapurna Buildcon</h2>
                           ...
                           <div className="row">
                            ...
                            <div className='d-flex gap-2' id='showse'>
                                <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/utsav_camps/monsoon_event_post-1721482342.jpg" alt="" />
                                <div className="alls">
                            ...
                            <div className="col-lg-4">
                            <div className='d-flex gap-2' id='showse'>
                                <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/utsav_camps/monsoon_event_post_2-1721482342.jpg" alt="" />
                                <div className="alls">
                                    <button id='views'>View</button>
                                </div>
                            ...
                            <div className="col-lg-4">
                            <div className='d-flex gap-2' id='showse'>
                                <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/utsav_camps/monsoon_event_post_3-1721482342.jpg" alt="" />
                                <div className="alls">
                                    <button id='views'>View</button>
                                </div>
